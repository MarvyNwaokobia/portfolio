    ...
    <section id="about" className="border-b border-border/80 px-6 py-20">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-6 space-y-5 text-base leading-relaxed text-muted-foreground">
          ...
          <p>
            I also build outside of any specific stack or chain — implementing
            cryptographic primitives, a toy EVM, and other systems from
            scratch to understand how the tools I rely on actually work.
          </p>
        </div>
      </div>
    </section>
